...
import com.example.pharmacieapplication.ui.myoffres.MyOffresFragment;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (res.getString("code").equals("404")) {
                        ...
                        ArrayList<Integer> ids = StaticVariable.db.getAllOffres();
                        offres.clear();
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            if (ids.contains(offre.getOfferId()))
                                offre.setFav(true);
                            offres.add(offre);
                        }
                        LinearLayoutManager llm = new LinearLayoutManager(OffresFragment.this.getContext());
